...
const ICOMOON_ZIP_NAME = "icomoon.zip";
...
const PAGE = {
  ...
  GENERATE_LINK_IMAGE: 'a[href="#/select/image"]',
  GLYPH_SET: "#set0",
  // GLYPH_SET: "#glyphSet0",
...
async function pipeline(options = {}) {
  try {
    ...
    await page.goto("https://icomoon.io/app/#/select/image");
    ...
    logger(`Started to download ${ICOMOON_ZIP_NAME}`);
    const zipPath = path.join(outputDir, ICOMOON_ZIP_NAME);
